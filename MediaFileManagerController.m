...
@interface MediaFileManagerController ()
@end

@implementation MediaFileManagerController{
...
{
    self = [super initWithNibName:@"MediaFileManagerController" bundle:nil];
    if (self) {
        // Initialization code here.
        _afcHander=fileHander;
        _device=device;
...
-(BOOL)copyFromDevice:(NSString*)devicePath1 toDevice:(NSString*)devicePath2{
    if ([devicePath1 isEqualToString:devicePath2]) {
        return NO;
    }
    BOOL ret=NO;
